...
class FriendListToMainSegue: UIStoryboardSegue {
    ...
    override func perform() {
        ...
        UIView.animateWithDuration(0.4, animations: {
            ...
            guard let destinationViewController = self.destinationViewController as? MainMapViewController else { return }
