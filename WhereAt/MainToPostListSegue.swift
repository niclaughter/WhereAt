...
class MainToPostListSegue: UIStoryboardSegue {
    ...
    override func perform() {
        ...
        UIView.animateWithDuration(0.4, animations: { 
            ...
            destinationVCView.frame = CGRectOffset(destinationVCView.frame, -screenWidth, 0.0)
                ...
                guard let destinationViewController = self.destinationViewController as? PostListTableViewController else { return }
